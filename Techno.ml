...
let rec typeOf e =
  match e with
    ...
    | TUnion(e1,e2) ->
        ...
        | TechnoLang, TechnoLang -> TechnoMultiLine
    ...
    | TAppendToList(s,l) ->
        ...
        | TechnoString, TechnoLang -> TechnoMultiLine
    ...
    | TCap(i, e) ->
        ...
        | TechnoInt, TechnoLang -> TechnoMultiLine
